...
WebUI.callTestCase(findTestCase('04初始化設定/新增預設模板節目部'), [('teamParam') : Team], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('04初始化設定/新增節目管理系統'), [('teamParam') : Team], FailureHandling.STOP_ON_FAILURE)
