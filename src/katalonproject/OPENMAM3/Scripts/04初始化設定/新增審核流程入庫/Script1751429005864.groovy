...
WebUI.click(findTestObject('系統設定/審核流程頁/歸檔行為'))
...
//WebUI.callTestCase(findTestCase('04初始化設定/新增審核順位一選擇'), ['valueParam':'單位主管'], FailureHandling.CONTINUE_ON_FAILURE)

//WebUI.click(findTestObject('系統設定/審核流程頁/順位一/單位主管'))
