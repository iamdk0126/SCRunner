...
// 1. 獲取 MediaType List
List StartDateList = GlobalVariable.Team1CRStartDate

List EndDateList = GlobalVariable.Team1CREndDate
...
CustomKeywords.'custom.TeamKeywords.clickTeam'("Team1")
...
for (int i = 1; i <= count; i++) {
    ...
    WebUI.setText(findTestObject('系統設定/列管資訊頁/輸入列管資訊名稱'), GlobalVariable.Team1CR[i-1])
