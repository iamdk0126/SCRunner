...
// 1. 獲取 MediaType List
List StartDateList = GlobalVariable.Team2CRStartDate
List EndDateList = GlobalVariable.Team2CREndDate
...
CustomKeywords.'custom.TeamKeywords.clickTeam'("Team2")
...
WebUI.setText(findTestObject('系統設定/列管資訊頁/輸入列管資訊名稱'), GlobalVariable.Team2CR[i-1])
