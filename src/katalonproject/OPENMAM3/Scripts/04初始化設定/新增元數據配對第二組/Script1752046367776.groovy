...
WebUI.click(findTestObject('系統設定/OpenShare頁/元數據配對頁/編輯元數據配對'))
...
WebUI.click(findTestObject('系統設定/OpenShare頁/元數據配對頁/元數據配對儲存'))

WebUI.delay(5)

WebUI.click(findTestObject('系統設定/OpenShare頁/openshare啟用系統'))
