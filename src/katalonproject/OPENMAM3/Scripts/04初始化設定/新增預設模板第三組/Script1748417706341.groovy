...
def templateMap = GlobalVariable.Team3TemplateMap
...
for (int i = 1; i <= count; i++) {
    ...
    // [改動 3] 呼叫子測試案例，並傳入 value
    //WebUI.callTestCase(findTestCase('04初始化設定/新增預設模板選擇媒資分類'), [('valueParam') : specificvalue], FailureHandling.CONTINUE_ON_FAILURE)
