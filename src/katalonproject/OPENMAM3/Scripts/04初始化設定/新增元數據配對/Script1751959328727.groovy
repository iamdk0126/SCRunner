...
// --- 1. 定義元數據與對應選項的映射 ---
def metadataMap = GlobalVariable.metadataMap
...
WebUI.click(findTestObject('系統設定/節目管理系統頁/元數據配對頁/編輯元數據配對'))
...
WebUI.click(findTestObject('系統設定/節目管理系統頁/元數據配對頁/元數據配對儲存'))

WebUI.delay(5)

WebUI.click(findTestObject('系統設定/節目管理系統頁/啟用系統'))
