...
List Team2BossList = GlobalVariable.Team2Boss

int Bosscount = Team2BossList.size()

List Team2LeaderList = GlobalVariable.Team2Leader

int Leadercount = Team2LeaderList.size()

List Team2UserList = GlobalVariable.Team2User

int Usercount = Team2UserList.size()
...
for (int i = 1; i <= count; i++) {
    ...
    if (i == 1) {
        for (int j = 1; j <= Bosscount; j++) {
            String currentBoss = Team2BossList.get(j - 1)
    ...
    if (i == 2) {
        for (int j = 1; j <= Leadercount; j++) {
            String currentLeader = Team2LeaderList.get(j - 1)
    ...
    if (i == 3) {
        for (int j = 1; j <= Usercount; j++) {
            String currentUser = Team2UserList.get(j - 1)
