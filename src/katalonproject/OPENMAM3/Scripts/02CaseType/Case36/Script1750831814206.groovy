...
*/
WebUI.callTestCase(findTestCase('05BaseTest/新增媒資錄製影片HDCH6TC'), [('indexParam') : specificindex], FailureHandling.STOP_ON_FAILURE)
...
WebUI.closeBrowser()
*/
println('已完成 Case36 - 新增媒資錄製影片SD')

WebUI.comment('已完成 Case36 - 新增媒資錄製影片SD')
