...
//def specifickeyword = '台酒漏網3900'
//def specifickeyword = CustomKeywords.'custom.dbHelper.getRandomAssetNameWithoutCopyright'(0,1)
...
println('已完成 Case6 - 未公開媒資 (搜尋)')

WebUI.comment('已完成 Case6 - 未公開媒資 (搜尋)')
