...
'隨機讀取一筆公開媒資名稱'
def specifickeyword = WebUI.callTestCase(findTestCase('05BaseTest/選擇公開列管關鍵字'), [:], FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('05BaseTest/媒資送播'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.closeBrowser()
*/
println('已完成 Case34 - 公開媒資(列管送播)')
WebUI.comment('已完成 Case34 - 公開媒資(列管送播)')
