...
WebUI.callTestCase(findTestCase('05BaseTest/新增媒資上傳隨機可設迴圈'), [('RunloopParam') : specificRunloop], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('05BaseTest/登出'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.closeBrowser()

println('已完成 Case4 - 新增(空)媒資')
