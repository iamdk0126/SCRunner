...
WebUI.callTestCase(findTestCase('05BaseTest/一鍵回調'), [:], FailureHandling.STOP_ON_FAILURE)
...
println('已完成 Case18 - 公開媒資(回調列管-一鍵回調-核准)')
WebUI.comment('已完成 Case18 - 公開媒資(回調列管-一鍵回調-核准)')
