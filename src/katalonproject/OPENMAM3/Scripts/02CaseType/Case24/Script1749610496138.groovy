...
WebUI.callTestCase(findTestCase('05BaseTest/剪輯一鍵回調'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('05BaseTest/填寫回調原因'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('05BaseTest/回調審核核准'), [('accountParam') : account,('keywordParam') : specifickeyword], FailureHandling.STOP_ON_FAILURE)

println('已完成 Case24 - 公開媒資(回調列管-剪輯一鍵回調-核准)')
WebUI.comment('已完成 Case24 - 公開媒資(回調列管-剪輯一鍵回調-核准)')
