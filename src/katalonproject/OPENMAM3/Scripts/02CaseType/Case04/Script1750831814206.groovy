...
*/
WebUI.callTestCase(findTestCase('05BaseTest/新增媒資上傳隨機給外部迴圈用'), [('indexParam') : specificindex], FailureHandling.STOP_ON_FAILURE)
...
WebUI.closeBrowser()
*/
println('已完成 Case4 - 新增Local媒資')

WebUI.comment('已完成 Case4 - 新增Local媒資')
