...
WebUI.callTestCase(findTestCase('05BaseTest/回調審核核准'), [('accountParam') : account, ('keywordParam') : specifickeyword], 
    FailureHandling.STOP_ON_FAILURE)

println('已完成 Case14 - 公開媒資(回調無列管-一鍵回調-核准)')

WebUI.comment('已完成 Case14 - 公開媒資(回調無列管-一鍵回調-核准)')
