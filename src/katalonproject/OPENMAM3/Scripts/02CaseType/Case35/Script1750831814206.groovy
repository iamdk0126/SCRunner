...
*/
WebUI.callTestCase(findTestCase('05BaseTest/新增媒資錄製影片HDCH7'), [('indexParam') : specificindex], FailureHandling.STOP_ON_FAILURE)
...
WebUI.closeBrowser()
*/
println('已完成 Case35 - 新增媒資錄製影片')

WebUI.comment('已完成 Case35 - 新增媒資錄製影片')
