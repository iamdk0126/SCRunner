...
WebUI.callTestCase(findTestCase('05BaseTest/媒資回調'), [:], FailureHandling.STOP_ON_FAILURE)
...
println('已完成 Case20 - 公開媒資(回調列管-媒資回調-核准)')
WebUI.comment('已完成 Case20 - 公開媒資(回調列管-媒資回調-核准)')
