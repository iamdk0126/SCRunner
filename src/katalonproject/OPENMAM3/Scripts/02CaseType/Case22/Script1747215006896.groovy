...
//WebUI.callTestCase(findTestCase('05BaseTest/填寫回調原因'), [:], FailureHandling.CONTINUE_ON_FAILURE)
...
println('已完成 Case22 - 公開媒資(回調無列管-剪輯一鍵回調-核准)')

WebUI.comment('已完成 Case22 - 公開媒資(回調無列管-剪輯一鍵回調-核准)')
