...
WebUI.callTestCase(findTestCase('05BaseTest/公開檢視媒資資訊PlayVideo'), [('keywordParam') : specifickeyword], FailureHandling.STOP_ON_FAILURE)

println('已完成 Case12 - 公開媒資(檢視媒資資訊)')
WebUI.comment('已完成 Case12 - 公開媒資(檢視媒資資訊)')
