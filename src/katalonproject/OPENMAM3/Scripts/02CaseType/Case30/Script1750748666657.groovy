...
WebUI.callTestCase(findTestCase('05BaseTest/未公開媒資送播'), [:], FailureHandling.OPTIONAL)
...
WebUI.callTestCase(findTestCase('05BaseTest/送播審核核准'), [('accountParam') : account, ('keywordParam') : specifickeyword], 
    FailureHandling.STOP_ON_FAILURE)

println('已完成 Case30 - 未公開媒資(無列管送播-核准)')

WebUI.comment('已完成 Case30 - 未公開媒資(無列管送播-核准)')
