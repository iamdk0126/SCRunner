...
String UserNo = GlobalVariable.TestUser47
...
if (executionTimeInMinutes > 0) {
    ...
    while (System.currentTimeMillis() < endTime) {
		...
		String specifickeyword = GlobalVariable.MultiAccessAssetName
		
		//def specifickeyword = '短帶: 夾中介法2000 宣傳帶'
        ...
        if (result) {
            ...
            if (l1Status) {
                ...
                WebUI.callTestCase(findTestCase('05BaseTest/回調審核核准'), [('accountParam'):specificAccount, ('keywordParam'):specifickeyword, ('endTimeParam'):endTime], FailureHandling.STOP_ON_FAILURE)
                WebUI.callTestCase(findTestCase('05BaseTest/登出'), [:], FailureHandling.STOP_ON_FAILURE)
            } else {
