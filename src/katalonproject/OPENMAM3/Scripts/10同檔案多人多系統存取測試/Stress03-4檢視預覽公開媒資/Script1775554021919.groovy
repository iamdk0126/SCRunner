...
String UserNo = GlobalVariable.TestUser49
...
if (executionTimeInMinutes > 0) {
	...
	while (System.currentTimeMillis() < endTime) {
		...
		WebUI.callTestCase(findTestCase('02CaseType/Case12公開PlayVideo'), [('accountParam') : specificAccount, ('keywordParam'): specifickeyword], FailureHandling.STOP_ON_FAILURE)
	...
	for (def index : (0..runloop - 1)) {
        ...
        boolean result = WebUI.callTestCase(findTestCase('02CaseType/Case12公開PlayVideo'), [('accountParam'):specificAccount, ('keywordParam'):specifickeyword], FailureHandling.STOP_ON_FAILURE)
