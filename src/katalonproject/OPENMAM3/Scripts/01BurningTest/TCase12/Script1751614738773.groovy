...
// --- 定義此特定執行要使用的帳號密碼 ---
String specificAccount = 'test212'
...
for (def index : (0..runloop - 1)) {
    ...
    WebUI.callTestCase(findTestCase('02CaseType/Case12公開PlayVideo'), [('accountParam') : specificAccount], FailureHandling.STOP_ON_FAILURE)
