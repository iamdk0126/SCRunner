...
WebUI.setText(findTestObject('主畫面/未公開媒資頁/輸入關鍵字'), specifickeyword)
...
for (def index : (0..runloop - 1)) {
    ...
    WebUI.callTestCase(findTestCase('02CaseType/Case05'), [('keywordParam') : specifickeyword], FailureHandling.OPTIONAL)
}
