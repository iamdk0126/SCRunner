...
WebUI.callTestCase(findTestCase('04初始化設定/新增其他媒資設定元數據配對'), [('teamParam') : Team], FailureHandling.STOP_ON_FAILURE)
WebUI.callTestCase(findTestCase('04初始化設定/新增其他媒資設定吸菸卡設定'), [('teamParam') : Team], FailureHandling.STOP_ON_FAILURE)
WebUI.callTestCase(findTestCase('04初始化設定/新增其他媒資設定警示卡設定'), [('teamParam') : Team], FailureHandling.STOP_ON_FAILURE)
WebUI.callTestCase(findTestCase('04初始化設定/新增其他媒資設定播出類型設定'), [('teamParam') : Team], FailureHandling.STOP_ON_FAILURE)

println('已完成 新增檔案來源類型。')
