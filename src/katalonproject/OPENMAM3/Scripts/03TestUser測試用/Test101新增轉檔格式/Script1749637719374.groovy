...
String specificAccount = "test103" //GlobalVariable.TestUser1
String specificDomain = 'VMEDIA'
...
WebUI.callTestCase(findTestCase('04初始化設定/新增轉檔格式'), [('teamParam') : Team], FailureHandling.CONTINUE_ON_FAILURE)
