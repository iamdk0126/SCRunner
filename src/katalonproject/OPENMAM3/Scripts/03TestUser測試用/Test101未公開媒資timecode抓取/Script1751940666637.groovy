...
//WebUI.callTestCase(findTestCase('04初始化設定/新增列管第二組'), [:], FailureHandling.STOP_ON_FAILURE)
//WebUI.callTestCase(findTestCase('04初始化設定/新增列管第三組'), [:], FailureHandling.STOP_ON_FAILURE)
println('已完成 新增欄位。')
