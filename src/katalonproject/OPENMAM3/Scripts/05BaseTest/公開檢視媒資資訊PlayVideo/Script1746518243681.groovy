...
'點媒資'
WebUIExtensions.retryClick(findTestObject('主畫面/未公開媒資頁/Page_/item1'))
...
WebUIExtensions.retryClick(findTestObject('主畫面/媒資資訊頁/關鍵影格'))

'點媒資資訊列管資訊'
WebUIExtensions.retryClick(findTestObject('主畫面/媒資資訊頁/列管資訊'))

WebUIExtensions.retryClick(findTestObject('主畫面/媒資資訊頁/QC報告'))
