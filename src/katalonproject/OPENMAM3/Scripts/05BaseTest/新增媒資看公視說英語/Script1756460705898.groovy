...
'集數隨機7884~8195'
int randomX = 7884 + rand.nextInt(311)
...
correspondingTitle = "看公視說英語: "+correspondingTitle
...
*/
	...
	WebUIExtensions.retrySetText(findTestObject('主畫面/編輯媒資頁/節目編號'), '0000082')
	...
	WebUIExtensions.setTextByLabel('節目名稱', '看公視說英語')
	
	WebUI.delay(1)
	
	DropdownHelper.selectDropdownOptionByLabel('節目名稱','看公視說英語 (ID:0000082)')
