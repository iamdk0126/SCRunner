...
/*
	...
	*/	
		...
		String startTC =""
		String endTC =""
		String correspondingTitle = titleParam
		...
		*/
		...
		/*	def tcButton = CustomKeywords.'custom.TimecodeHelper.createXPathObject'("//div[@role='dialog' and .//div[text()='編輯媒資']]//button[@title='E']']")
			...
			*/
			...
			correspondingTitle = correspondingTitle + " ${detectedFPS}"
			...
			// 填寫「短帶Timecode起」並選好 29.97
			CustomKeywords.'custom.WebUIExtensions.setAntTimecodeWithFPS'("短帶Timecode起", startTC, detectedFPS)
			
			// 填寫「短帶Timecode止」並選好 29.97
			CustomKeywords.'custom.WebUIExtensions.setAntTimecodeWithFPS'("短帶Timecode迄", endTC, detectedFPS)
