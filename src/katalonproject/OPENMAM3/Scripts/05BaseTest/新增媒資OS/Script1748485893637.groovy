...
'搜尋2100'
WebUI.setText(findTestObject('主畫面/新增媒資頁/OpenShare匯入頁/openshareIn_inputName'), '')
...
WebUI.callTestCase(findTestCase('05BaseTest/抓取OpenShare匯入VideoID'), [:], FailureHandling.CONTINUE_ON_FAILURE)

WebUI.callTestCase(findTestCase('05BaseTest/OpenShare匯入分析VideoID選擇媒資分類'), [:], FailureHandling.CONTINUE_ON_FAILURE)
