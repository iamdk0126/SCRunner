...
'點回調送播'
if (WebUI.verifyElementClickable(findTestObject('主畫面/媒資資訊頁/未公開媒資送播'), FailureHandling.OPTIONAL)) {
	

	WebUIExtensions.retryClick(findTestObject('主畫面/媒資資訊頁/未公開媒資送播'))
