...
String recordsource = "Live"

String recordresolution = 'SD' // HD or SD
...
*/
	...
	//correspondingTitle = channel+" "+recordsource+recordresolution+" " + correspondingTitle
...
/*
    ...
    if (WebUI.verifyElementClickable(findTestObject('主畫面/未公開媒資頁/編輯媒資1'), FailureHandling.OPTIONAL)) {
		...
		WebUI.callTestCase(findTestCase('05BaseTest/錄製影片Live'), [('TitleParam') : Title, ('channelParam') : channelOption , ('resolutionParam') : recordresolution], FailureHandling.STOP_ON_FAILURE)
	...
	WebUI.delay(150)  //1分鐘後開始錄影 + 錄影時間 1分鐘 + 檔案上傳時間 暫訂30秒
