...
if (WebUI.waitForElementClickable(findTestObject('檔案管理頁/媒資歸檔頁/全部勾選'), 10,FailureHandling.OPTIONAL)) {
    ...
    WebUI.setText(findTestObject('檔案管理頁/媒資歸檔頁/核准輸入審核說明'), '這裡輸入審核說明')
...
if (WebUI.waitForElementClickable(findTestObject('檔案管理頁/媒資歸檔頁/搜尋'), 10,FailureHandling.OPTIONAL)) {
WebUI.click(findTestObject('檔案管理頁/媒資歸檔頁/搜尋'))
}
