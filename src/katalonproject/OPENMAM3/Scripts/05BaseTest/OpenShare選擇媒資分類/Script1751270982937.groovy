...
// --- 1. 初始化設定 ---
String targetOptionText = GlobalVariable.G_specificVideoID

def selectTrigger = findTestObject('主畫面/新增媒資頁/OpenShare匯入頁/Page_/div_')

def selectInput = findTestObject('主畫面/新增媒資頁/OpenShare匯入頁/Page_/input__rc_select_6')
