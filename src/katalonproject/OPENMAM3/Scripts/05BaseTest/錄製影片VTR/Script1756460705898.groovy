...
if (recordresolution.equalsIgnoreCase('SD+HD')) { recordmode = "HD"}
if (recordresolution.equalsIgnoreCase('SD')) { recordmode = "SD"}
...
/*				
WebUI.click(findTestObject('主畫面/編輯媒資頁/錄製影片頁/input_VTR_vtr-start-time'))
		
WebUI.setText(findTestObject('主畫面/編輯媒資頁/錄製影片頁/input_VTR_vtr-start-time'), '00:21:00:00')
		
WebUI.sendKeys(findTestObject('主畫面/編輯媒資頁/錄製影片頁/input_VTR_vtr-start-time'), Keys.chord(Keys.ENTER))
*/
//TimecodeHelper.inputTimecode(findTestObject('主畫面/編輯媒資頁/錄製影片頁/input_VTR_vtr-start-time'), '00:21:00:00')
/*
WebUI.click(findTestObject('主畫面/編輯媒資頁/錄製影片頁/input_VTR_vtr-end-time'))
		
WebUI.setText(findTestObject('主畫面/編輯媒資頁/錄製影片頁/input_VTR_vtr-end-time'), '00:22:00:00')
		
WebUI.sendKeys(findTestObject('主畫面/編輯媒資頁/錄製影片頁/input_VTR_vtr-end-time'), Keys.chord(Keys.ENTER))
*/
//TimecodeHelper.inputTimecode(findTestObject('主畫面/編輯媒資頁/錄製影片頁/input_VTR_vtr-start-time'), '00:22:00:00')

String domain = GlobalVariable.DOMAIN

if (domain == "OPEN") { TimecodeHelper.setVTRRange2("00:10:00:00", "00:20:00:00", false, false) 
	
	} else if (domain == "PTS") { TimecodeHelper.setVTRRange2("01:10:00:00", "01:20:00:00", false, false) }
...
DropdownHelper.selectDropdownOptionByLabel('錄製解析度',  recordmode)
