...
// --- 定義此特定執行要使用的帳號密碼 ---
String specificAccount = 'test214'
...
if (executionTimeInMinutes > 0) {
	...
	while (System.currentTimeMillis() < endTime) {
		...
		WebUI.callTestCase(findTestCase('06二審CaseType/L2一鍵回調'), [('accountParam') : specificAccount, ('keywordParam') : specifickeyword], FailureHandling.STOP_ON_FAILURE)
	}
