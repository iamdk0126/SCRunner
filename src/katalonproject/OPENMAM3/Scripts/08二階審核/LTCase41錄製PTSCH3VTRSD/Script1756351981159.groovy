...
int runloop = GlobalVariable.runloopCase4
...
// --- 定義此特定執行要使用的帳號密碼 ---
String UserNo = GlobalVariable.TestUser41
...
if (executionTimeInMinutes > 0) {
    ...
    while (System.currentTimeMillis() < endTime) {
		...
		WebUI.callTestCase(findTestCase('05BaseTest/新增媒資錄製影片PTSVTRSDCH3'), [:], FailureHandling.STOP_ON_FAILURE)
