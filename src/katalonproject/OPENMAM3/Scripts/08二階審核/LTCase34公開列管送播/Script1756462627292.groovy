...
// --- 定義此特定執行要使用的帳號密碼 ---
String UserNo = GlobalVariable.TestUser34
...
if (executionTimeInMinutes > 0) {
	...
	while (System.currentTimeMillis() < endTime) {
		...
		boolean result = WebUI.callTestCase(findTestCase('06二審CaseType/L2公開送播'), [('accountParam') : specificAccount, ('keywordParam') : specifickeyword], FailureHandling.STOP_ON_FAILURE)
